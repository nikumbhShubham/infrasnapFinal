...
const SuperStructureDashboard = () => {
    const [allSuperStrutureImages, setallSuperStrutureImages] = useState([]);
    ...
    useEffect(() => {
        const fetchImages = async () => {
            const basePath = `${user.uid}/${site.id}/SuperStruture`;
            ...
            try {
                ...
                setallSuperStrutureImages(allImages);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-indigo-50 p-8">
            ...
            <header className="mb-12">
                <h1 className="text-5xl font-bold text-indigo-700 text-center mb-4">SuperStructure Dashboard</h1>
            ...
            <section className="mb-16">
                ...
                <Slider {...sliderSettings}>
                    {allSuperStrutureImages.map((url, index) => (
...
export default SuperStructureDashboard;