...
const PlinthDashboard = () => {
    const [allPlinthImages, setallPlinthImages] = useState([]);
...
"  Ground Level Finishing ",
    ];

    useEffect(() => {
        const fetchImages = async () => {
            const basePath = `${user.uid}/${site.id}/Plinth`;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-indigo-50 p-8">
            ...
            <header className="mb-12">
                <h1 className="text-5xl font-bold text-indigo-700 text-center mb-4">Plinth Dashboard</h1>
...
export default PlinthDashboard;